...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_API_MODE": {
        ...
        "description": "Select the official Tushare Pro API (tushare) or a Relay gateway (relay). Relay requires TUSHARE_RELAY_BASE_URL and TUSHARE_RELAY_KEY.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["tushare", "relay"],
        "validation": {},
        "display_order": 11,
        "help_key": "settings.data_source.TUSHARE_API_MODE",
        "examples": ["TUSHARE_API_MODE=tushare", "TUSHARE_API_MODE=relay"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F%E5%AE%8C%E6%95%B4%E5%88%97%E8%A1%A8",
            },
        ],
    },
    "TUSHARE_RELAY_BASE_URL": {
        "title": "Tushare Relay Base URL",
        "description": "Base URL for the Tushare Relay gateway, for example https://relay.example.com/tushare/pro.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 12,
        "help_key": "settings.data_source.TUSHARE_RELAY_BASE_URL",
        "examples": ["TUSHARE_RELAY_BASE_URL=https://relay.example.com/tushare/pro"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F%E5%AE%8C%E6%95%B4%E5%88%97%E8%A1%A8",
    ...
    "TUSHARE_RELAY_KEY": {
        ...
        "description": "Client Key sent in the X-API-Key header by TUSHARE_RELAY_BASE_URL.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
        ...
        "display_order": 13,
        "warning_codes": ["secret_value"],
        "help_key": "settings.data_source.TUSHARE_RELAY_KEY",
        "examples": ["TUSHARE_RELAY_KEY=your_relay_client_key"],
        "docs": [
            {
                "label": "完整指南：环境变量完整列表",
                "href": "https://github.com/ZhuLinsen/daily_stock_analysis/blob/main/docs/full-guide.md#%E7%8E%AF%E5%A2%83%E5%8F%98%E9%87%8F%E5%AE%8C%E6%95%B4%E5%88%97%E8%A1%A8",
